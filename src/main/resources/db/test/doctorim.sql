...
ALTER TABLE ROLES_PERMISSIONS ADD CONSTRAINT ROLES_PERMISSIONS_PK PRIMARY KEY (ROLE_ID,PERMISSION_ID);
ALTER TABLE ROLES_PERMISSIONS ADD CONSTRAINT ROLES_PERMISSIONS_USER_FK FOREIGN KEY (ROLE_ID) REFERENCES ROLES(ID) ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE ROLES_PERMISSIONS ADD CONSTRAINT ROLES_PERMISSIONS_ROLE_FK FOREIGN KEY (PERMISSION_ID) REFERENCES PERMISSIONS(ID) ON UPDATE NO ACTION ON DELETE NO ACTION;
